...
:root {
  ...
  {% set button_background = settings.button_primary_background_color %}
  {% set button_foreground = settings.button_primary_foreground_color %}
  ...
  {% set header_background = main_background %}
  {% set header_foreground = main_foreground %}
