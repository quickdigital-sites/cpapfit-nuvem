...
- [x] **Banners no submenu desktop** — mecanismo (nativo `navigation-banner`) + estilo prontos; falta o **lojista cadastrar** os banners reais no admin (ver [PENDENCIAS.md](PENDENCIAS.md)).
